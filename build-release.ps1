# WinDirStat - Release Build Script
# This script builds WinDirStat in Release mode
...
Write-Host "WinDirStat Release Build" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Configuration: Release" -ForegroundColor Yellow
Write-Host "Platform: x64" -ForegroundColor Yellow
Write-Host ""

# Build the project
Write-Host "Starting build..." -ForegroundColor Cyan
$buildCmd = "`"$vsDevCmd`" && msbuild windirstat.sln /p:Configuration=Release /p:Platform=x64 /t:$buildTarget /m /v:minimal"
