@ECHO OFF
REM WinDirStat - Debug Build Script
REM This script builds WinDirStat in Debug mode
...
msbuild windirstat.sln /p:Configuration=Debug /p:Platform=x64 /t:!BUILDTARGET! /m /v:minimal
